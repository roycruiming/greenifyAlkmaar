...
public class GlobalGameHandler : MonoBehaviour
{
    ...
    private void InitUnlockAbles() {
        ...
        instance.allUnlockables = GlobalGameHandler.GetAllUnlockables();
    ...
    public static List<Unlockable> GetAllUnlockables() {
        ...
        //Every class gets saved/loaded in the Unlockable constructor 

        allLoadedUnlockables.Add(new Unlockable(0,0,0,"test3",true,UnlockableType.character, "man+casual",true)); //set the initial info, if info has already been set constructor loads the saved info and initializes the object
        allLoadedUnlockables.Add(new Unlockable(1,1644,2,"clown face",false,UnlockableType.character, "man+clown")); 
        allLoadedUnlockables.Add(new Unlockable(2,2030,2,"super woman",false,UnlockableType.character, "woman+superhero")); 
        allLoadedUnlockables.Add(new Unlockable(3,550,2,"ninja man",false,UnlockableType.character, "man+ninja")); 
        allLoadedUnlockables.Add(new Unlockable(4,320,3,"astronaut man",false,UnlockableType.character, "man+astronaut")); 
        allLoadedUnlockables.Add(new Unlockable(5,320,3,"police woman",false,UnlockableType.character, "woman+police")); 
        allLoadedUnlockables.Add(new Unlockable(6,320,3,"test3",false,UnlockableType.character)); //this one is ignored.

        return allLoadedUnlockables;
    }
